...
$logDir = Join-Path $repo 'logs\ecl96_lambda_logit_confirm_itr3_lr5e4_20260421'
...
$experiments = @(
  @{ name='01_baseline_itr3'; args=@('--model_id','ecl96_confirm_lr5e4_baseline_itr3','--des','ECL96ConfirmBaseLR5e4') },
  @{ name='02_static_anchor_itr3'; args=@('--model_id','ecl96_confirm_lr5e4_static_anchor_itr3','--des','ECL96ConfirmAnchorLR5e4') + $graphCommon },
  @{ name='03_lambda_favor_static_itr3'; args=@('--model_id','ecl96_confirm_lr5e4_lambda_favor_static_itr3','--des','ECL96ConfirmLambdaFavorStaticLR5e4') + $graphCommon + @('--graph_lambda_logit_bias','True','--graph_lambda_logit_bias_polarity','favor_static') }
)
