...
| Weather | 96 | 0.180918 / 0.221948 | 0.173706 / 0.214354; dBase +3.99% / +3.42% | Active_MSE_only; 0.173233 / 0.215034; dStatic +0.27% / -0.32% | 0.169801 / 0.210550; dStatic +2.25% / +1.77%; MSE-primary dAdaptive +0.07% / -0.03% | Adaptive fusion headline; strict target gate falls back, while MSE-primary is MSE-positive but MAE-negative. |
