...
PROFILES = {
    "etth196_static": {
        ...
        "interface_dir": DATA_ROOT / "interfaces" / "ETTh1_graph_interface_cmiknn_ridgebase_sparse",
        ...
        "lambda_dir": AUDIT_ROOT / "etth196_lambda_feature_sweep",
        "lambda_prefix": "etth196",
        "out_dir": AUDIT_ROOT / "etth196_closed_loop",
        "split": "ett_hour",
        "date_col": "date",
        "header_mode": "infer",
        "sep": ",",
    },
    "etth196_static_parcorr": {
        "data_csv": DATASET_DIR / "ETTh1.csv",
        "interface_dir": DATA_ROOT / "interfaces" / "ETTh1_graph_interface_parcorr_ridgebase_sparse",
        "static_pattern": "etth196_validate_static_anchor_itr3_*projection_*",
        "baseline_pattern": "etth196_validate_baseline_itr3_*projection_*",
        "lambda_dir": AUDIT_ROOT / "etth196_lambda_feature_sweep",
        "lambda_prefix": "etth196",
        "out_dir": AUDIT_ROOT / "etth196_closed_loop_parcorr",
        "split": "ett_hour",
        "date_col": "date",
        "header_mode": "infer",
        "sep": ",",
    ...
    "weather96_static_pat3": {
        "data_csv": DATASET_DIR / "weather.csv",
        "interface_dir": DATA_ROOT / "interfaces" / "Weather_graph_interface_parcorr",
        "static_pattern": "weather_96_96_staticcausal_pat3_check_*projection_*",
        "baseline_pattern": "weather_96_96_papercfg_pat3_check_*projection_*",
        "lambda_dir": AUDIT_ROOT / "weather96_lambda_feature_sweep",
        "lambda_prefix": "weather96_static",
        "out_dir": AUDIT_ROOT / "weather96_closed_loop_pat3",
        "split": "custom_ratio",
        "date_col": "date",
        "header_mode": "infer",
        "sep": ",",
    ...
    "solar192_static": {
        "data_csv": DATASET_DIR / "Solar" / "solar_AL.txt",
        "interface_dir": DATA_ROOT / "interfaces" / "Solar_graph_interface_parcorr",
        "static_pattern": "solar_96_192_staticcausal_softmax_itr3_*projection_*",
        "baseline_pattern": "solar_96_192_baseline_itr3_*projection_*",
        "lambda_dir": AUDIT_ROOT / "solar192_lambda_feature_sweep",
        "lambda_prefix": "solar192_static",
        "out_dir": AUDIT_ROOT / "solar192_closed_loop",
        "split": "custom_ratio",
        "date_col": None,
        "header_mode": "none",
        "sep": ",",
