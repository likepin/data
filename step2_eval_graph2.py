...
def main():
    ...
    adj_hat = np.load(os.path.join(data_dir, "cmiknn_knn20_alpha0.020_adj_hat.npy"))
    ...
    plot_adj(adj_hat,  "PCMCI CMIKNN20 adjacency (collapsed)", os.path.join(data_dir, "adj_hat_CMIKNN.png"))

    print("[OK] Saved plots: adj_true.png, adj_hat_CMIKNN.png")
