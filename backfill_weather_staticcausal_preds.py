...
VARIANTS = {
    "baseline": {
        "model_id": "weather_96_96_baseline_itr3",
        "des": "Exp_baseline_itr3",
        "graph_enable": False,
    },
    "baseline_pat3_check": {
        "model_id": "weather_96_96_papercfg_pat3_check",
        "des": "Exp_pat3_check",
        "graph_enable": False,
    },
    "static": {
        "model_id": "weather_96_96_staticcausal_softmax_itr3",
        "des": "Exp_staticcausal_softmax_itr3",
        "graph_enable": True,
    },
    "static_pat3_check": {
        "model_id": "weather_96_96_staticcausal_pat3_check",
        "des": "Exp_staticcausal_pat3_check",
        "graph_enable": True,
    },
}
...
def build_args(variant: str) -> Namespace:
    ...
    return Namespace(
        ...
        graph_interface_dir=r"C:\Users\cyl\Desktop\data\interfaces\Weather_graph_interface_parcorr",
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Backfill Weather-96 validation/test predictions from saved checkpoints.")
