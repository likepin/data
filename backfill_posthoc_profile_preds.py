...
PROFILES = {
    ...
    "solar192_static": {
        ...
        "variants": {
            "baseline": {
                "model_id": "solar_96_192_baseline_itr3",
                "des": "Exp_baseline_itr3",
                "graph_enable": False,
            },
            "static": {
                "model_id": "solar_96_192_staticcausal_softmax_itr3",
                "des": "Exp_staticcausal_softmax_itr3",
                "graph_enable": True,
            },
        },
...
def build_args(profile_name: str, variant: str) -> Namespace:
    ...
    return Namespace(
        ...
        seq_len=int(profile.get("seq_len", 96)),
        label_len=int(profile.get("label_len", 48)),
        pred_len=int(profile.get("pred_len", 96)),
