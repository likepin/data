...
def main():
    ...
    adj_hat = np.load(os.path.join(data_dir, "parcorr_adj_hat.npy"))
    ...
    plot_adj(adj_hat,  "PCMCI ParCorr adjacency (collapsed)", os.path.join(data_dir, "parcorr_adj_hat.png"))

    print("[OK] Saved plots: adj_true.png, parcorr_adj_hat.png")
